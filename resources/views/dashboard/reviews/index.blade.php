    ...
    <div class="main-container">
            ...
            <div class="row gutters">
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="@lang('icons.reviews')"></i></a></li>
                            <li class="breadcrumb-item"><a
                                    href="{{ route(env('DASH_URL').'.index') }}">@lang('site.home')</a></li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('site.reviews')</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 text-right">
                    <a href="{{ route(env('DASH_URL').'.reviews.archive') }}"
        ...
        <div class="content-wrapper">
            <div class="row gutters" id="data">
                @include('dashboard.reviews._favorite_data')
            </div>
        </div>
        @endsection
        ...
        @push('scripts')
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    function featch_data(page) {
                        $.ajax({
                            data: $("#search_form").serialize(),
                            url: "{{ route(env('DASH_URL').'.reviews.index') }}" + "?page=" + page,
                            success: function (data) {
            ...
            <script src="{{ asset('public/dash_assets/js/star_ratings.js') }}" type="text/javascript"></script>
            <link rel="stylesheet" type="text/css" href="{{ asset('public/dash_assets/css/star_ratings.css') }}">
    @endpush
