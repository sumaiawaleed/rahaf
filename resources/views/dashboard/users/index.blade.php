            ...
            <div class="row gutters">
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="@lang('icons.users')"></i></a></li>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 text-right">
                    <a href="{{ route(env('DASH_URL').'.users.create') }}"
                       class="btn btn-success mb-2 pull-right">@lang('site.add_users')</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="search_form" action="{{ route(env('DASH_URL').'.users.index') }}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive" id="table_data">
                                    @include('dashboard.users.partials._pagination_data')
                                </div>
                            </div>
                        </div>
                    </div>
