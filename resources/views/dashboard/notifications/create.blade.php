            ...
            <div class="row gutters">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route(env('DASH_URL').'.notifications.index') }}">@lang('site.notifications')</a>
                        </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="add_new_form" method="post"
                                  action="{{ route(env('DASH_URL').'.notifications.store') }}"
                                  enctype="multipart/form-data">
                                {{ method_field('post') }}
                                {{ csrf_field() }}
                                @include('dashboard.notifications._form')
