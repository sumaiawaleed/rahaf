        ...
        <div class="page-title">
            <div class="row gutters">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 text-right">
                    <a href="{{ route(env('DASH_URL').'.customers.create') }}"
                       class="btn btn-success mb-2 pull-right">@lang('site.add_customer')</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="search_form" action="{{ route(env('DASH_URL').'.customers.index') }}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive" id="table_data">
                                    @include('dashboard.customer.partials._pagination_data')
                                </div>
                            </div>
                        </div>
                    </div>
