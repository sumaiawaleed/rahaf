                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('site.ratings')</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive" id="table_data">
                                    @include('dashboard.ratings.partials._pagination_data')
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <nav aria-label="Page navigation example">
                                    {{ $data['ratings']->appends(request()->query())->links() }}
                                </nav>
                            </div>
                        </div>
                    </div>
