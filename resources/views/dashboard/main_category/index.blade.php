                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('site.main_categories')</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 text-right">
                    <a href="{{ route(env('DASH_URL').'.main_categories.create') }}"
                       class="btn btn-success mb-2 pull-right">@lang('site.add_main_category')</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="search_form" action="{{ route(env('DASH_URL').'.main_categories.index') }}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive" id="table_data">
                                    @include('dashboard.main_category.partials._pagination_data')
                                </div>
                            </div>
                        </div>
                    </div>
