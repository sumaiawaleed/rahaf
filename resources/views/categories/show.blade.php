                            ...
                            <div class="collection-filter-block creative-card creative-inner">
                                <div class="product-service">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4>@lang('site.spatial_offers')</h4>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="product-slick ">
                                        <div><img width="400" height="520" src="{{ $row->getImageSize(400,500) }}"
                                                  alt=""
                                                  class="img-fluid  image_zoom_cls-3"></div>
                                        @foreach($data['extras'] as $ex)
                                            <div><img width="400" height="520" src="{{ $ex->getImageSize(400,500) }}"
                                                      alt=""
                                                      class="img-fluid  image_zoom_cls-3"></div>
                                        @endforeach
                                    </div>
                                    <div class="row">
                                        <div class="col-12 p-0">
                                            <div class="slider-nav">
                                                <div><img width="114" height="147"
                                                          src="{{ $row->getImageSize(114,147) }}" alt=""
                                                          class="img-fluid  image_zoom_cls-0"></div>
                                                @foreach($data['extras'] as $ex)
                                                    <div><img width="114" height="147"
                                                              src="{{ $ex->getImageSize(114,147) }}" alt=""
                                                              class="img-fluid  image_zoom_cls-0"></div>
                                                @endforeach
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-7 rtl-text">
                                    <div class="product-right">
                                        ...
                                        @endif
                                        <form class="rahaf-cart-form" method="post" action="{{ route('add_to_cart') }}">
                                            {{ method_field('post') }}
                                            {{ csrf_field() }}
                                            <ul class="color-variant">
                                                @foreach($data['extras'] as $color)
                                                    @if($ex->color_id != 17)
                                                        <li style="background: {!! $ex->color !!}"></li>

                                                        <input id="radio_{{ $ex->color_id }}" style="display: none"
                                                               onchange="$('#search_form').submit();" type="radio"
                                                               value="{{ $color->id }}"
                                                               name="color_id">
                                                        <li onclick="check_color({{ $color->id }})"
                                            ...
                                            <div class="product-buttons">
                                                <div class="form-group">
                                                    ...
                                                    <button
                                                        class="btn btn-normal btn-outline-light rahaf-add-cart">@lang('site.add_to_cart')</button>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="border-product">
                                            <h6 class="product-title">@lang('site.description')</h6>
                                            <p>{!! $row->getTranslateDesc() !!}</p>
                                        </div>
                                        <div class="border-product">
                                            <div class="product-icon">
                                                ...
                                                @if($row->is_fav)
                                                    <form method="post"
                                                          class="d-inline-block rahaf-wishlist-form-details"
                                                        ...
                                                        <div class="form-group" id="fav_{{ $row->id }}">
                                                            ...
                                                            <button class="wishlist-btn" type="submit"
                                                                ...
                                                                <i id="whish_icon_{{ $row->icon }}"
                                                                   class="fa fa-heart"></i>
                                                                <span
                                                                    class="title-font">@lang('site.remove_from_wishlist')</span>
                                                            </button>
                                                        </div>
                                                    </form>
                                                @else
                                                    <form method="post"
                                                          class="d-inline-block rahaf-wishlist-form-detail"
                                                          action="{{ route('wishlist') }}">
                                                        {{ method_field('post') }}
                                                        {{ csrf_field() }}
                                                        <div class="form-group" id="fav_{{ $row->id }}">
                                                            ...
                                                            <button class="wishlist-btn" type="submit"
                                                                ...
                                                                <span
                                                                    class="title-font">@lang('site.add_to_wishlist')</span>
                                                            </button>
                                                        </div>
                                                    </form>
                                                @endif
                                                ...
                                                @foreach($data['reviews'] as $review)
                                                    <li class="col-md-12">
                                                        <div class="media">
                                                            <div class="media-body">
                                                                <div class="row">
                                                                    <div class="col-md-6"><h6>{{ $review->name }} <span>( {{ substr($review->the_date,0,10) }} )</span>
                                                                        </h6>
                                                                    </div>
                                                                ...
                                                                <p>{{ $review->comment }}
                                                                @auth('customers')
                                                                    @if(@auth('customers')->user()->id == $review->user_id)
                                                                        @php $is_allow = false; @endphp
                                                                        <form method="post"
                                                                              action="{{ route('user/delete_rate') }}">
                                                                            {{ csrf_field() }}
                                                                            {{ method_field('post') }}
                                                                            <input type="hidden" name="id"
                                                                                   value="{{ $review->rate_id }}">
                                                                            <button
                                                                                class="btn btn-outline-danger pull-right delete-rate-btn">
                                        ...
                                        <div class="col-sm-12 ">
                                            <div class="creative-card">
                                                ...
                                                <section class='rating-widget' dir="ltr">
                                                    ...
                                                    <div class='rating-stars text-center'>
                                                        <ul id='stars'>
                                                            ...
                                                            <li class='star' title='Excellent' data-value='2'>
                                                                <i class='fa fa-star fa-fw'></i>
                                                            </li>
                                                            <li class='star' title='WOW!!!' data-value='1'>
                                                                <i class='fa fa-star fa-fw'></i>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <form method="post" action="{{ route('user/rate') }}">
                                                    ...
                                                    <input type="hidden" value="5" id="rate_value" name="rate">

                                                    <textarea class="form-control" name="comment"
                                                              placeholder="@lang('site.comment')"></textarea>
                                                    <br>
                                                    <button type='submit'
                                                            class='btn btn-success'>@lang('site.add')</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row ">
                <div class="col-12 product">
                    <div class="product-slide no-arrow">
                        @foreach($data['more_products'] as $row)
                            <div>
                                <div class="product-box">
                                    ...
                                    <div class="product-detail detail-center ">
                                        ...
                                        <div class="icon-detail">
                                            @auth('customers')
                                                <form class="rahaf-cart-form" method="post"
                                                      action="{{ route('wishlist') }}">
                                                    {{ method_field('post') }}
                                                    {{ csrf_field() }}
                                                    <div class="form-group">
                                                ...
                                                @if($row->is_fav)
                                                    <form method="post" class="rahaf-wishlist-form-details"
                                                          action="{{ route('wishlist') }}">
                                                        {{ method_field('post') }}
                                                        {{ csrf_field() }}
                                                        <div class="form-group" id="fav_{{ $row->id }}">
...
@push('scripts')
    @include('categories.partials.show_js')
@endpush
