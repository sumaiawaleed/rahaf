...
class Product extends Model
{
    ...
    protected $appends = ["image_path", "category_name", "price_name", 'total_rate', 'is_fav','sku_data'];

    public function getSkuDataAttribute(){
    ...
    {
        $extras = ExtraImage::with('color')->where('product_id', $this->id)->get();
        return $extras;
    }
}
